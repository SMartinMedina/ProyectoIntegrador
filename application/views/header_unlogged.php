...
<html lang="en">
	<head>
		...
		<!-- INICIO ESTILOS MOBILE CLIENTES-->
		<!-- vector map CSS -->
		<link href="<?php echo base_url();?>vendors/bower_components/jquery-wizard.js/css/wizard.css" rel="stylesheet" type="text/css"/>
		
		<!-- jquery-steps css -->
		<link rel="stylesheet" href="<?php echo base_url();?>vendors/bower_components/jquery.steps/demo/css/jquery.steps.css">
		...
		<script src="<?php echo base_url();?>vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
				<!-- Validator JS-->
		<script src="<?php echo base_url();?>vendors/bower_components/bootstrap-validator/dist/validator.min.js"></script>		


				<!-- INICIO JS DE VISTA MOBILE CLIENTE-->
		...
		<!-- FIN JS DE VISTA MOBILE CLIENTE-->
	</head>