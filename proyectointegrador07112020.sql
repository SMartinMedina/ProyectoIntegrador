...
-- Dumping data for table proyectointegrador.tiempo_estimado_especialista: 6 rows
...
-- Dumping data for table proyectointegrador.turnos: ~19 rows (approximately)
DELETE FROM `turnos`;
...
INSERT INTO `usuarios` (`id`, `id_rol`, `nombre`, `apellido`, `usuario`, `password`, `email`, `fecha_alta`, `fecha_baja`) VALUES
	...
	(3, 3, 'Cli Nombre', 'Apell', 'cliente@cliente.com', 'e10adc3949ba59abbe56e057f20f883e', 'cliente@asdasd.com', '2020-10-07 22:20:26', NULL),
